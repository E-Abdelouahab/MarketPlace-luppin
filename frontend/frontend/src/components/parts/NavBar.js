...
export default function NavBar() {
  ...
  <div className="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
    <div className="text-md font-bold text-blue-700 lg:flex-grow">
      ...
      <Link to='/productByCategory/gold' className=" block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-green-700 mr-2">
        gold
      </Link>
      <Link to='/productByCategory/Silver' className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-green-700 mr-2">
        Silver 
      </Link>
      <Link to='/productByCategory/copper' className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-green-700 mr-2">
        copper
      </Link>
      <Link to='/productByCategory/accessories' className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-green-700 mr-2">
        old accessories
      </Link>
    </div>
